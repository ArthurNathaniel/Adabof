...
<body id="content">
    ...
    <div id="print-section">
        ...
        <div class="payment_details">
            <h2>Payment Info:</h2>
            <p><strong>Mobile Money Number: </strong>+233 20 838 5656</p>
            <p><strong>Mobile Money Name: </strong>Adabof Steel Complex</p>
    ...
    <script>
        ...
        document.getElementById('downloadBtn').addEventListener('click', function() {
            ...
            const options = {
                filename: 'Adabof Steel Complex - ' + billedTo + '.pdf', // Set PDF filename with billed to name
                image: {
                    type: 'jpeg',
                    quality: 0.98
                }, // Image quality
