    ...
    <div class="create_invoice_all">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) . '?id=' . $expenditure_id; ?>" method="post">
            ...
            <div class="forms">
                ...
                <input type="text" id="phone" name="phone" value="<?php echo $expenditure['phone']; ?>" required>
            </div>
            ...
            <div class="forms">
                ...
                <input type="text" id="description" name="description" value="<?php echo $expenditure['description']; ?>" required>
            </div>
